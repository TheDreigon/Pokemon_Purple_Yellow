MapSongBanks::
	...
	db MUSIC_PEWTER_CITY, BANK(Music_PewterCity) ; PEWTER_CITY
	db MUSIC_CERULEAN_CITY, BANK(Music_CeruleanCity) ; CERULEAN_CITY
	...
	db MUSIC_CINNABAR_ISLAND, BANK(Music_CinnabarIsland) ; CINNABAR_ISLAND
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; INDIGO_PLATEAU
	db MUSIC_SAFFRON_CITY, BANK(Music_SaffronCity) ; SAFFRON_CITY
	...
	db MUSIC_CINNABAR, BANK(Music_Cinnabar) ; ROUTE_19
	db MUSIC_CINNABAR, BANK(Music_Cinnabar) ; ROUTE_20
	db MUSIC_CINNABAR, BANK(Music_Cinnabar) ; ROUTE_21
	...
	db MUSIC_CERULEAN_CITY, BANK(Music_CeruleanCity) ; CERULEAN_TRASHED_HOUSE
	db MUSIC_CERULEAN_CITY, BANK(Music_CeruleanCity) ; CERULEAN_MELANIES_HOUSE
	db MUSIC_POKECENTER, BANK(Music_Pokecenter) ; CERULEAN_POKECENTER
	db MUSIC_GYM, BANK(Music_Gym) ; CERULEAN_GYM
	db MUSIC_CERULEAN_CITY, BANK(Music_CeruleanCity) ; BIKE_SHOP
	...
	db MUSIC_OAKS_LAB, BANK(Music_OaksLab) ; BILLS_HOUSE
	...
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; SEAFOAM_ISLANDS_B1F
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; SEAFOAM_ISLANDS_B2F
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; SEAFOAM_ISLANDS_B3F
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; SEAFOAM_ISLANDS_B4F
	db MUSIC_CITIES2, BANK(Music_Cities2) ; VERMILION_GOOD_ROD_HOUSE
	db MUSIC_CITIES2, BANK(Music_Cities2) ; FUCHSIA_FOSSIL_HOUSE
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion) ; POKEMON_MANSION_1F
	db MUSIC_GYM, BANK(Music_Gym) ; CINNABAR_GYM
	db MUSIC_CINNABAR_ISLAND, BANK(Music_CinnabarIsland) ; CINNABAR_LAB
	db MUSIC_CINNABAR_ISLAND, BANK(Music_CinnabarIsland) ; CINNABAR_LAB_TRADE_ROOM
	db MUSIC_CINNABAR_ISLAND, BANK(Music_CinnabarIsland) ; CINNABAR_LAB_METRONOME_ROOM
	db MUSIC_CINNABAR_ISLAND, BANK(Music_CinnabarIsland) ; CINNABAR_LAB_FOSSIL_ROOM
	db MUSIC_POKECENTER, BANK(Music_Pokecenter) ; CINNABAR_POKECENTER
	db MUSIC_POKECENTER, BANK(Music_Pokecenter) ; CINNABAR_MART
	db MUSIC_CINNABAR_ISLAND, BANK(Music_CinnabarIsland) ; CINNABAR_MART_COPY
	...
	db MUSIC_YELLOW_UNUSED_SONG, BANK(Music_YellowUnusedSong) ; FIGHTING_DOJO
	...
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; SEAFOAM_ISLANDS_1F
	...
	db MUSIC_CERULEAN_CITY, BANK(Music_CeruleanCity) ; CERULEAN_BADGE_HOUSE
	db MUSIC_CINNABAR_ISLAND, BANK(Music_CinnabarIsland) ; UNUSED_MAP_E7
