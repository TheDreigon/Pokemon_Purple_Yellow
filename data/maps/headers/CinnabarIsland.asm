	...
	connection north, Route21, ROUTE_21, 3 ; world-design: was +4 when Route 21 was 10 wide; the route gained a column on its WEST side, which already shifts its content one block right, so the offset drops by one to keep the same on-screen alignment. Mirror in Route21.asm must stay -3.
