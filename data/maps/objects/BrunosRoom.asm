...
BrunosRoom_Object:
	...
	def_object_events
	object_event  5,  2, SPRITE_BRUNO, STAY, DOWN, TEXT_BRUNOSROOM_BRUNO, OPP_BRUNO, 1, 0
	object_event  5,  2, SPRITE_BRUNO, STAY, DOWN, TEXT_BRUNOSROOM_BRUNO_REMATCH, OPP_BRUNO, 2, 0
