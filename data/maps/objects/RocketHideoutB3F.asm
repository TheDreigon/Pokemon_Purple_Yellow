	...
	const_export ROCKETHIDEOUTB3F_TM_POISON_BITE
...
RocketHideoutB3F_Object:
	...
	def_object_events
	object_event 10, 22, SPRITE_ROCKET, STAY, RIGHT, TEXT_ROCKETHIDEOUTB3F_ROCKET1, OPP_ROCKET, 14, 2
	object_event 26, 12, SPRITE_ROCKET, STAY, UP, TEXT_ROCKETHIDEOUTB3F_ROCKET2, OPP_ROCKET, 15, 4
	object_event 26, 17, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB3F_TM_POISON_BITE, TM_POISON_BITE
