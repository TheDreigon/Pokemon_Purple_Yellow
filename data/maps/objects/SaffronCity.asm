...
SaffronCity_Object:
	...
	object_event 16,  8, SPRITE_ROCKET, WALK, LEFT_RIGHT, TEXT_SAFFRONCITY_ROCKET2
	...
	object_event 19, 30, SPRITE_ROCKET, WALK, LEFT_RIGHT, TEXT_SAFFRONCITY_ROCKET7
	object_event  7, 14, SPRITE_SCIENTIST, WALK, ANY_DIR, TEXT_SAFFRONCITY_SCIENTIST
	object_event 25, 24, SPRITE_SILPH_WORKER_M, STAY, NONE, TEXT_SAFFRONCITY_SILPH_WORKER_M
	...
	object_event 20,  8, SPRITE_ROCKER, STAY, UP, TEXT_SAFFRONCITY_ROCKER
