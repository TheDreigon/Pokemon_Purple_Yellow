	...
	const_export POKEMONTOWER6F_TM_SHADOW_BALL
...
PokemonTower6F_Object:
	...
	object_event 14, 14, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONTOWER6F_TM_SHADOW_BALL, TM_SHADOW_BALL ; v0.5 Phase B.4: was X_ACCURACY
