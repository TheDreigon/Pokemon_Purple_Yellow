...
VermilionCity_Object:
	...
	warp_event  7,  3, VERMILION_GOOD_ROD_HOUSE, 1

	def_bg_events
	bg_event 21,  7, TEXT_VERMILIONCITY_SIGN
	...
	def_object_events
	object_event 23,  4, SPRITE_COOLTRAINER_F, WALK, LEFT_RIGHT, TEXT_VERMILIONCITY_BEAUTY
	object_event 14,  7, SPRITE_GAMBLER, STAY, NONE, TEXT_VERMILIONCITY_GAMBLER1
	object_event 19, 30, SPRITE_SAILOR, STAY, UP, TEXT_VERMILIONCITY_SAILOR1
	object_event 28,  6, SPRITE_GAMBLER, STAY, NONE, TEXT_VERMILIONCITY_GAMBLER2
	object_event 30,  7, SPRITE_MACHOP, WALK, UP_DOWN, TEXT_VERMILIONCITY_MACHOP
