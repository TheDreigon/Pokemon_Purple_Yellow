	...
	const_export SILPHCO7F_MAX_POTION
	const_export SILPHCO7F_TM_LEECH_LIFE
	const_export SILPHCO7F_UNUSED ; unused vanilla leftover: no corresponding object_event (its hide_show_data.asm entry was removed; const is now unreferenced)
...
SilphCo7F_Object:
	...
	object_event 13,  1, SPRITE_ROCKET, STAY, DOWN, TEXT_SILPHCO7F_ROCKET1, OPP_ROCKET, 32, 2
	object_event  2, 13, SPRITE_SCIENTIST, STAY, DOWN, TEXT_SILPHCO7F_SCIENTIST, OPP_SCIENTIST, 8, 3
	object_event 20,  2, SPRITE_ROCKET, STAY, LEFT, TEXT_SILPHCO7F_ROCKET2, OPP_ROCKET, 33, 3
	object_event 19, 14, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO7F_ROCKET3, OPP_ROCKET, 34, 4
	object_event  3,  7, SPRITE_BLUE, STAY, UP, TEXT_SILPHCO7F_RIVAL
	object_event  1,  9, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO7F_MAX_POTION, MAX_POTION
