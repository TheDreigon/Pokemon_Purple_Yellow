...
RockTunnelPokecenter_Object:
	...
	object_event  5,  3, SPRITE_GENTLEMAN, STAY, DOWN, TEXT_ROCKTUNNELPOKECENTER_GENTLEMAN
	object_event  7,  1, SPRITE_FISHER, STAY, NONE, TEXT_ROCKTUNNELPOKECENTER_FISHER
	object_event  5,  1, SPRITE_LINK_RECEPTIONIST, STAY, DOWN, TEXT_ROCKTUNNELPOKECENTER_LINK_RECEPTIONIST
