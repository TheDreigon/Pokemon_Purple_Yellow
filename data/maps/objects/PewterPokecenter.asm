...
PewterPokecenter_Object:
	...
	object_event  7,  5, SPRITE_GENTLEMAN, STAY, LEFT, TEXT_PEWTERPOKECENTER_GENTLEMAN
	object_event  1,  3, SPRITE_JIGGLYPUFF, STAY, DOWN, TEXT_PEWTERPOKECENTER_JIGGLYPUFF
	object_event  5,  1, SPRITE_LINK_RECEPTIONIST, STAY, DOWN, TEXT_PEWTERPOKECENTER_LINK_RECEPTIONIST
