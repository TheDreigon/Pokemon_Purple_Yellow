...
Route15_Object:
	...
	object_event 36,  5, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROUTE15_COOLTRAINER_F3, OPP_JR_TRAINER_F, 22
	object_event 18, 13, SPRITE_COOLTRAINER_F, STAY, UP, TEXT_ROUTE15_COOLTRAINER_F4, OPP_JR_TRAINER_F, 23
	object_event 17,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE15_TM_CHARM, TM_CHARM ; world-design reposition (was TM_RAGE in April; TM renamed since, position is his)
