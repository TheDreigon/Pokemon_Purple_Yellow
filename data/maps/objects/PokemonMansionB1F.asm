	...
	const_export POKEMONMANSIONB1F_TM_DARK_PULSE
	const_export POKEMONMANSIONB1F_TM_SHADOW_BALL
...
PokemonMansionB1F_Object:
	...
	def_object_events
	object_event 16, 23, SPRITE_SUPER_NERD, STAY, NONE, TEXT_POKEMONMANSIONB1F_BURGLAR, OPP_BURGLAR, 9, 0
	object_event 27, 11, SPRITE_SCIENTIST, STAY, DOWN, TEXT_POKEMONMANSIONB1F_SCIENTIST, OPP_SCIENTIST, 13, 3
	object_event  4, 12, SPRITE_MEW, STAY, DOWN, TEXT_POKEMONMANSIONB1F_MEW, MEW, 70, 0
	...
	object_event 19, 25, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_TM_DARK_PULSE, TM_DARK_PULSE
	object_event  5,  4, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_TM_SHADOW_BALL, TM_SHADOW_BALL
