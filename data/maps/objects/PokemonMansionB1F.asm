	...
	const_export POKEMONMANSIONB1F_TM_ROCK_SLIDE
...
PokemonMansionB1F_Object:
	...
	object_event 19, 25, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_TM_SOLARBEAM, TM_DARK_PULSE
	object_event  5,  4, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_TM_ROCK_SLIDE, TM_ROCK_SLIDE
