...
Route9_Object:
	...
	object_event 10,  5, SPRITE_COOLTRAINER_M, STAY, RIGHT, TEXT_ROUTE9_COOLTRAINER_M2, OPP_JR_TRAINER_M, 8
	object_event 48,  8, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROUTE9_COOLTRAINER_F2, OPP_JR_TRAINER_F, 6
	object_event 20, 15, SPRITE_HIKER, STAY, LEFT, TEXT_ROUTE9_HIKER1, OPP_HIKER, 11
	object_event 43,  3, SPRITE_HIKER, STAY, LEFT, TEXT_ROUTE9_HIKER2, OPP_HIKER, 6
	object_event 35,  6, SPRITE_YOUNGSTER, STAY, DOWN, TEXT_ROUTE9_YOUNGSTER1, OPP_BUG_CATCHER, 13
	...
	object_event 33,  2, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE9_TM_RAGE, TM_RAGE ; world-design reposition (ball was TM_TELEPORT in April; TM renamed since, position is his)
