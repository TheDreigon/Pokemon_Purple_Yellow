	...
	const_export ROCKTUNNELB1F_TM_IRON_TAIL ; v0.5 Phase B.4
...
RockTunnelB1F_Object:
	...
	object_event  4,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKTUNNELB1F_TM_IRON_TAIL, TM_IRON_TAIL ; v0.5 Phase B.4 (placeholder coords; adjust in PolishedMap)
