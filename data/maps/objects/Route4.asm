...
Route4_Object:
	...
	object_event 31, 15, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE4_TM_QUICK_ATTACK, TM_QUICK_ATTACK ; world-design reposition (was TM_RAZOR_WIND in April; TM renamed since, position is his)
