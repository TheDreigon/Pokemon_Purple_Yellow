...
Route21_Object:
	...
	def_object_events
	object_event 13, 11, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE21_CALCIUM, CALCIUM
	...
	object_event 10, 30, SPRITE_SWIMMER, STAY, UP, TEXT_ROUTE21_SWIMMER1, OPP_SWIMMER, 12
	object_event 12, 31, SPRITE_SWIMMER, STAY, RIGHT, TEXT_ROUTE21_SWIMMER2, OPP_CUE_BALL, 9
	object_event 11, 81, SPRITE_SWIMMER, STAY, DOWN, TEXT_ROUTE21_SWIMMER3, OPP_SWIMMER, 13
	object_event  5, 70, SPRITE_SWIMMER, STAY, RIGHT, TEXT_ROUTE21_SWIMMER4, OPP_SWIMMER, 14
	object_event 14, 70, SPRITE_SWIMMER, STAY, LEFT, TEXT_ROUTE21_SWIMMER5, OPP_SWIMMER, 15
