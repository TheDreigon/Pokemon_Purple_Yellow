...
SafariZoneNorth_Object:
	...
	def_object_events
	object_event 34, 10, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONENORTH_PROTEIN, PROTEIN
	object_event  5,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONENORTH_TM_DRAGON_CLAW, TM_DRAGON_CLAW
