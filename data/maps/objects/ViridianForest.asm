...
ViridianForest_Object:
	...
	object_event 19, 19, SPRITE_YOUNGSTER, STAY, LEFT, TEXT_VIRIDIANFOREST_YOUNGSTER4, OPP_BUG_CATCHER, 3
	object_event  4, 40, SPRITE_COOLTRAINER_F, STAY, NONE, TEXT_VIRIDIANFOREST_COOLTRAINER_F, OPP_LASS, 19
	object_event 10,  7, SPRITE_YOUNGSTER, STAY, RIGHT, TEXT_VIRIDIANFOREST_YOUNGSTER5, OPP_BUG_CATCHER, 15
