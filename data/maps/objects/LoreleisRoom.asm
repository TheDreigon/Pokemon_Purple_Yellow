...
LoreleisRoom_Object:
	...
	def_object_events
	object_event  5,  2, SPRITE_LORELEI, STAY, DOWN, TEXT_LORELEISROOM_LORELEI, OPP_LORELEI, 1, 0
	object_event  5,  2, SPRITE_LORELEI, STAY, DOWN, TEXT_LORELEISROOM_LORELEI_REMATCH, OPP_LORELEI, 2, 0
