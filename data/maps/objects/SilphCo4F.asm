	...
	const_export SILPHCO4F_DIRE_HIT
...
SilphCo4F_Object:
	...
	object_event  9, 14, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO4F_ROCKET1, OPP_ROCKET, 26, 4
	object_event 14,  6, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO4F_SCIENTIST, OPP_SCIENTIST, 5, 3
	object_event 26, 10, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO4F_ROCKET2, OPP_ROCKET, 27, 4
	...
	object_event  5,  8, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO4F_DIRE_HIT, DIRE_HIT
