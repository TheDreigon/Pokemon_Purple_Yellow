	...
	const_export MTMOONB2F_TM_FAINT_ATTACK
...
MtMoonB2F_Object:
	...
	object_event 15, 22, SPRITE_ROCKET, STAY, DOWN, TEXT_MTMOONB2F_ROCKET1, OPP_ROCKET, 2, 4
	object_event 29, 11, SPRITE_ROCKET, STAY, UP, TEXT_MTMOONB2F_ROCKET2, OPP_ROCKET, 3, 4
	object_event 29, 17, SPRITE_ROCKET, STAY, LEFT, TEXT_MTMOONB2F_ROCKET3, OPP_ROCKET, 1, 4
	...
	object_event 29,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOONB2F_TM_FAINT_ATTACK, TM_FAINT_ATTACK
