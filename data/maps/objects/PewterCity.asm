...
PewterCity_Object:
	...
	warp_event  15, 29, PEWTER_SPEECH_HOUSE, 1
	warp_event 13, 25, PEWTER_POKECENTER, 1

	def_bg_events
	bg_event  7, 25, TEXT_PEWTERCITY_TRAINER_TIPS
	bg_event 21, 11, TEXT_PEWTERCITY_POLICE_NOTICE_SIGN
	bg_event 24, 17, TEXT_PEWTERCITY_MART_SIGN
	bg_event 14, 25, TEXT_PEWTERCITY_POKECENTER_SIGN
	bg_event 13,  9, TEXT_PEWTERCITY_MUSEUM_SIGN
	bg_event 11, 17, TEXT_PEWTERCITY_GYM_SIGN
	bg_event 19, 23, TEXT_PEWTERCITY_SIGN

	def_object_events
	object_event  6, 16, SPRITE_COOLTRAINER_F, STAY, NONE, TEXT_PEWTERCITY_COOLTRAINER_F
	object_event 17, 24, SPRITE_COOLTRAINER_M, STAY, NONE, TEXT_PEWTERCITY_COOLTRAINER_M
	object_event 21, 14, SPRITE_SUPER_NERD, STAY, NONE, TEXT_PEWTERCITY_SUPER_NERD1
	object_event 26, 26, SPRITE_SUPER_NERD, WALK, LEFT_RIGHT, TEXT_PEWTERCITY_SUPER_NERD2
