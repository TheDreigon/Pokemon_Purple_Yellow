	...
	const_export SILPHCO3F_ZINC ; was HYPER_POTION - the split, 2026-09-06: ZINC visible 1/2
...
SilphCo3F_Object:
	...
	object_event 20,  7, SPRITE_ROCKET, STAY, LEFT, TEXT_SILPHCO3F_ROCKET, OPP_ROCKET, 25, 2
	object_event  7,  9, SPRITE_SCIENTIST, STAY, DOWN, TEXT_SILPHCO3F_SCIENTIST, OPP_SCIENTIST, 4, 3
	object_event  8,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO3F_ZINC, ZINC
