	...
	const_export CERULEANCAVE1F_TM_THRASH
...
CeruleanCave1F_Object:
	...
	object_event 18,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_CERULEANCAVE1F_TM_THRASH, TM_THRASH ; v0.5 Phase B.4: was ULTRA_BALL
