...
ViridianCity_Object:
	...
	def_bg_events
	bg_event 19, 23, TEXT_VIRIDIANCITY_SIGN
	bg_event 19,  1, TEXT_VIRIDIANCITY_TRAINER_TIPS1
	bg_event 31, 25, TEXT_VIRIDIANCITY_TRAINER_TIPS2
	...
	object_event 30, 24, SPRITE_YOUNGSTER, WALK, ANY_DIR, TEXT_VIRIDIANCITY_YOUNGSTER2
