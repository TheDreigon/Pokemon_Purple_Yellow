	...
	const_export DAYCARE2F_NIDORAN_M
...
; NIDORAN M's sheet is a 12-tile still (the F was the walker), so he STAYs.
	object_event  5,  5, SPRITE_NIDORANM, STAY, NONE, TEXT_DAYCARE2F_NIDORAN_M
