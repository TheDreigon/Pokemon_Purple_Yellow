...
CinnabarIsland_Object:
	...
	warp_event  9, 35, CINNABAR_MART, 1

	def_bg_events
	bg_event 15, 27, TEXT_CINNABARISLAND_SIGN
	bg_event 10, 35, TEXT_CINNABARISLAND_MART_SIGN
	...
	object_event 12,  9, SPRITE_GAMBLER, WALK, LEFT_RIGHT, TEXT_CINNABARISLAND_GAMBLER
