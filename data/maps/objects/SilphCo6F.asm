	...
	const_export SILPHCO6F_MAX_ETHER
...
SilphCo6F_Object:
	...
	object_event 17,  3, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO6F_ROCKET1, OPP_ROCKET, 30, 2
	object_event  7,  8, SPRITE_SCIENTIST, STAY, DOWN, TEXT_SILPHCO6F_SCIENTIST, OPP_SCIENTIST, 7, 3
	object_event 14, 15, SPRITE_ROCKET, STAY, LEFT, TEXT_SILPHCO6F_ROCKET2, OPP_ROCKET, 31, 2
	object_event  3, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO6F_MAX_ETHER, MAX_ETHER
