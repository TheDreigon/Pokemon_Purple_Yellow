...
SeafoamIslandsB4F_Object:
	...
	object_event  6, 1, SPRITE_KRIS, STAY, DOWN, TEXT_SEAFOAM_ISLANDS_WEEBRA, OPP_WEEBRA, 1 ; at Articuno's EXACT tile (6,1); missable HIDE, shown by script only post-Articuno + post-League. Talk-triggered, headerless.
