	...
	const_export SAFARIZONEWEST_TM_HURRICANE
	const_export SAFARIZONEWEST_IRON ; was PROTEIN - swapped with Route 12 so the Safari does not hold both PROTEINs (2026-09-06)
...
SafariZoneWest_Object:
	...
	def_object_events
	object_event  8, 21, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEWEST_MAX_POTION, MAX_POTION
	object_event 20,  9, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEWEST_TM_HURRICANE, TM_HURRICANE
	object_event 18, 18, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEWEST_IRON, IRON
	object_event  9,  9, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEWEST_GOLD_TEETH, GOLD_TEETH
