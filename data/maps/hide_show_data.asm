...
Route4HS:
	db ROUTE_4, ROUTE4_TM_KARATE_CHOP, SHOW
Route9HS:
	db ROUTE_9, ROUTE9_TM_DRAGON_CLAW, SHOW
Route12HS:
	db ROUTE_12, ROUTE12_SNORLAX,    SHOW
	db ROUTE_12, ROUTE12_TM_FAKE_TEARS, SHOW
	db ROUTE_12, ROUTE12_IRON,       SHOW
Route15HS:
	db ROUTE_15, ROUTE15_TM_HONE_CLAWS, SHOW
Route16HS:
...
Route24HS:
	...
	db ROUTE_24, ROUTE24_TM_DOUBLE_TEAM, SHOW
Route25HS:
...
CeruleanCaveHS:
	...
	db CERULEAN_CAVE_1F, CERULEANCAVE1F_TM_THRASH, SHOW
PokemonTower2FHS:
...
PokemonTower6FHS:
	...
	db POKEMON_TOWER_6F, POKEMONTOWER6F_TM_SHADOW_BALL, SHOW
PokemonTower7FHS:
...
VictoryRoad2FHS:
	...
	db VICTORY_ROAD_2F, VICTORYROAD2F_TM_HYDRO_PUMP, SHOW
	db VICTORY_ROAD_2F, VICTORYROAD2F_FULL_HEAL,     SHOW
	db VICTORY_ROAD_2F, VICTORYROAD2F_TM_FIRE_BLAST,  SHOW
...
MtMoon1FHS:
	...
	db MT_MOON_1F, MTMOON1F_TM_QUICK_ATTACK, SHOW
MtMoonB2FHS:
	...
	db MT_MOON_B2F, MTMOONB2F_TM_DAZE_GLEAM, SHOW
SSAnne2FHS:
...
SSAnneB1FRoomsHS:
	...
	db SS_ANNE_B1F_ROOMS, SSANNEB1FROOMS_TM_IRON_TAIL,    SHOW
	db SS_ANNE_B1F_ROOMS, SSANNEB1FROOMS_MAX_POTION, SHOW
VictoryRoad3FHS:
	db VICTORY_ROAD_3F, VICTORYROAD3F_MAX_REVIVE,   SHOW
	db VICTORY_ROAD_3F, VICTORYROAD3F_TM_BLIZZARD, SHOW
...
RocketHideoutB2FHS:
	...
	db ROCKET_HIDEOUT_B2F, ROCKETHIDEOUTB2F_TM_FAINT_ATTACK, SHOW
	db ROCKET_HIDEOUT_B2F, ROCKETHIDEOUTB2F_SUPER_POTION,  SHOW
RocketHideoutB3FHS:
	db ROCKET_HIDEOUT_B3F, ROCKETHIDEOUTB3F_TM_POISON_FANG, SHOW
...
RocketHideoutB4FHS:
	...
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_TM_LEECH_LIFE, SHOW
...
SilphCo7FHS:
	...
	db SILPH_CO_7F, SILPHCO7F_TM_DOUBLE_EDGE, SHOW
...
PokemonMansionB1FHS:
	...
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_TM_ROCK_SLIDE, SHOW
...
SafariZoneNorthHS:
	...
	db SAFARI_ZONE_NORTH, SAFARIZONENORTH_TM_DRAGON_RAGE, SHOW
SafariZoneWestHS:
...
VictoryRoad1FHS:
	db VICTORY_ROAD_1F, VICTORYROAD1F_TM_THUNDER, SHOW
