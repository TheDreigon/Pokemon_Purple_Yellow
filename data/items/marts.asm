...
CeladonMart2FClerk1Text::
	script_mart TM_WATER_GUN, TM_THUNDER_WAVE, TM_DISCHARGE, TM_REST, TM_SEISMIC_TOSS, TM_REST, TM_BIDE, TM_TELEPORT, TM_PAY_DAY

CeladonMart2FClerk2Text::
	script_mart TM_DOUBLE_TEAM, TM_REFLECT, TM_AERIAL_ACE, TM_HEAD_SMASH, TM_GUNK_SHOT, TM_MEGA_PUNCH, TM_HEAVY_SLAM, TM_TAKE_DOWN, TM_RAGE
...
CinnabarMartClerkText::
	script_mart ULTRA_BALL, HYPER_POTION, MAX_REPEL, ESCAPE_ROPE, FULL_HEAL, REVIVE, TM_BUBBLEBEAM, TM_DIG, TM_TRI_ATTACK, TM_MIMIC, TM_DARK_PULSE, TM_PSYWAVE, TM_METRONOME, TM_HEAD_SMASH
