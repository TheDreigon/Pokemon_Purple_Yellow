...
VoltAttackAnim:
	battle_anim NO_MOVE, SE_LIGHT_SCREEN_PALETTE
	battle_anim VOLT_ATTACK, SE_SLIDE_MON_OFF
...
DazeGleamAnim:
	battle_anim NO_MOVE, SE_LIGHT_SCREEN_PALETTE
	battle_anim DAZE_GLEAM, SUBANIM_0_BEAM, 0, 4
	battle_anim NO_MOVE, SE_DARK_SCREEN_FLASH
	battle_anim NO_MOVE, SE_RESET_SCREEN_PALETTE
	db -1 ; end
...
StrengthAnim:
	...
	battle_anim NO_MOVE, SE_RESET_MON_POSITION
	battle_anim NO_MOVE, SE_DELAY_ANIMATION_10
	battle_anim FIRE_PUNCH, SUBANIM_1_STAR_BIG_MOVING, 1, 8
	db -1 ; end
...
FlameWheelAnim:
	battle_anim FLAME_WHEEL, SUBANIM_1_FLAMES, 1, 6
...
MegaPunchAnim:
	battle_anim MEGA_PUNCH, SUBANIM_1_STAR_BIG_MOVING, 1, 4
	db -1 ; end
...
StoneEdgeAnim:
	battle_anim STONE_EDGE, SUBANIM_0_ROCKS_LIFT, 0, 2
	battle_anim NO_MOVE, SE_DARK_SCREEN_FLASH
	battle_anim NO_MOVE, SUBANIM_1_STAR_BIG_MOVING, 1, 4
	db -1 ; end
...
WorkUpAnim:
	battle_anim WORK_UP, SE_LIGHT_SCREEN_PALETTE
	battle_anim NO_MOVE, SE_SPIRAL_BALLS_INWARD
	battle_anim NO_MOVE, SE_RESET_SCREEN_PALETTE
	db -1 ; end
...
AcidArmorAnim:
	battle_anim LEECH_SEED, SE_LIGHT_SCREEN_PALETTE
	battle_anim RECOVER, SE_WAVY_SCREEN
...
AquaVeilAnim:
	battle_anim NO_MOVE, SE_LIGHT_SCREEN_PALETTE
	battle_anim AQUA_VEIL, SE_WATER_DROPLETS_EVERYWHERE
	battle_anim NO_MOVE, SE_RESET_SCREEN_PALETTE
	db -1 ; end
...
AromaticMistAnim:
	battle_anim NO_MOVE, SE_LIGHT_SCREEN_PALETTE
	battle_anim AROMATIC_MIST, SE_WATER_DROPLETS_EVERYWHERE
	battle_anim NO_MOVE, SE_RESET_SCREEN_PALETTE
	db -1 ; end
...
RockPolishAnim:
	battle_anim ROCK_POLISH, SE_LIGHT_SCREEN_PALETTE
	battle_anim NO_MOVE, SE_SHAKE_BACK_AND_FORTH
	battle_anim NO_MOVE, SE_RESET_SCREEN_PALETTE
	db -1 ; end
...
NobleRoarAnim:
	battle_anim NOBLE_ROAR, SUBANIM_1_SHOUT, 1, 6
...
FeatherDanceAnim:
	battle_anim FEATHER_DANCE, SE_LEAVES_FALLING
	db -1 ; end
...
DecayAnim:
	battle_anim DECAY, SUBANIM_1_BLOB_DRIP_ENEMY, 1, 6
	db -1 ; end
...
ConfideAnim:
	battle_anim CONFIDE, SUBANIM_0_HEART_1_MUSIC, 1, 6
	db -1 ; end
...
SludgeTrapAnim:
	battle_anim SLUDGE_TRAP, SUBANIM_1_BLOB_DRIP_ENEMY, 1, 6
	battle_anim NO_MOVE, SUBANIM_0_BIND, 0, 6
	db -1 ; end

SweetScentAnim:
	battle_anim SWEET_SCENT, SUBANIM_0_CIRCLES_FALLING, 0, 6
	db -1 ; end
...
MoonlightAnim:
	battle_anim MOONLIGHT, SE_BLINK_MON
	battle_anim NO_MOVE, SE_LIGHT_SCREEN_PALETTE
	battle_anim NO_MOVE, SE_SPIRAL_BALLS_INWARD
	battle_anim NO_MOVE, SE_RESET_SCREEN_PALETTE
	db -1 ; end
