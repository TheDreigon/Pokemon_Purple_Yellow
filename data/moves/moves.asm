...
Moves:
; Reorganized: Alphabetical by TYPE -> Ascending POWER -> Status moves last within type -> Signatures at bottom for power moves
	...
	move SHADOW_SNEAK, NO_ADDITIONAL_EFFECT,        50, GHOST,        100, 25 ; new move. priority.
