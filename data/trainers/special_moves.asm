...
SpecialTrainerMoves:
	...
	db ERIKA, 1 ; Celadon Gym (4th) — 35 TANGELA, 36 VICTREEBEL, 37 VILEPLUME, 38 VENUSAUR
	db 1, 1, WATER_GUN
	db 1, 2, VINE_WHIP
	db 1, 3, STUN_POWDER
	db 1, 4, LEECH_SEED
	...
	db GIOVANNI, 3 ; Viridian Gym — 53 GOLEM, 53 MACHAMP, 54 RHYDON, 54 CLOYSTER, 55 NIDOKING, 55 PERSIAN
	db 1, 1, EARTHQUAKE
	db 1, 2, ROCK_SLIDE
	db 1, 3, BODY_SLAM
	db 1, 4, IRON_HEAD
