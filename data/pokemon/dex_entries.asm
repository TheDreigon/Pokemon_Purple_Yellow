...
BeedrillDexEntry:
	db "LANCER@"
	db 1,2 ; height: meters, decimeters (v0.7 metric dex)
	dw 144 ; weight in 0.1 kg (v0.7 metric dex)
...
PidgeyDexEntry:
	...
	dw 30 ; weight in 0.1 kg (v0.7 metric dex)
...
ArbokDexEntry:
	db "HOODED@"
	db 3,2 ; height: meters, decimeters (v0.7 metric dex)
...
ArcanineDexEntry:
	db "MAJESTIC@"
	db 1,6 ; height: meters, decimeters (v0.7 metric dex)
	dw 640 ; weight in 0.1 kg (v0.7 metric dex)
...
MachokeDexEntry:
	db "SUPERPOWER@"
	db 1,6 ; height: meters, decimeters (v0.7 metric dex)
	dw 750 ; weight in 0.1 kg (v0.7 metric dex)
...
ShellderDexEntry:
	db "BIVALVE@"
	db 0,3 ; height: meters, decimeters (v0.7 metric dex)
	dw 50 ; weight in 0.1 kg (v0.7 metric dex)
...
OnixDexEntry:
	...
	dw 44000 ; weight in 0.1 kg (v0.7 metric dex)
...
TaurosDexEntry:
	db "STAMPEDE@"
	db 1,8 ; height: meters, decimeters (v0.7 metric dex)
	dw 3600 ; weight in 0.1 kg (v0.7 metric dex)
...
GyaradosDexEntry:
	db "DESTROYER@"
	db 7,6 ; height: meters, decimeters (v0.7 metric dex)
	dw 8400 ; weight in 0.1 kg (v0.7 metric dex)
...
LaprasDexEntry:
	...
	dw 4200 ; weight in 0.1 kg (v0.7 metric dex)
...
SnorlaxDexEntry:
	db "SLEEPING@"
	db 2,0 ; height: meters, decimeters (v0.7 metric dex)
	dw 5000 ; weight in 0.1 kg (v0.7 metric dex)
...
ArticunoDexEntry:
	db "FREEZE@"
	db 1,8 ; height: meters, decimeters (v0.7 metric dex)
	dw 625 ; weight in 0.1 kg (v0.7 metric dex)
...
MewtwoDexEntry:
	db "GENETIC@"
	db 1,9 ; height: meters, decimeters (v0.7 metric dex)
	dw 1100 ; weight in 0.1 kg (v0.7 metric dex)
