	...
	; tm/hm learnset
	; v0.7 Pass 3: Machoke bulkier humanoid powerhouse. auto
	; ROCK_THROW/BIND/SEISMIC_TOSS/BODY_SLAM/BULK_UP/TAKE_DOWN/STRENGTH.
	; bonus QUICK_ATTACK/BULLDOZE/RAGE/EARTHQUAKE/DOUBLE_EDGE/THRASH. HM
	; STRENGTH.
	tmhm ROCK_THROW, QUICK_ATTACK, BIND, BULLDOZE, SEISMIC_TOSS, \
	     RAGE, BODY_SLAM, BULK_UP, TAKE_DOWN, EARTHQUAKE, \
