	...
	base_stat_row 45, 80, 180, 90, 105, 45 ; hp atk def spatk spdef spd

	db WATER, ICE ; type
	db 60 ; catch rate  ; set by hand
	db 175 ; base exp  ; BST 440 - muitas fraquezas (-5)
	...
	tmhm BIND, WATER_PULSE, ICY_PULSE, BODY_SLAM, MIMIC, \
	     ...
	     LIGHT_SCREEN, ICE_BEAM, REFLECT, ROCK_SLIDE, SCARY_FACE, \
	     SURF, IRON_HEAD
	; end
