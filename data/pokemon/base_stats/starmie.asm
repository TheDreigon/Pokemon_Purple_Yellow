	...
	tmhm QUICK_ATTACK, WATER_PULSE, MIMIC, MIRROR_MOVE, SUBSTITUTE, \
	     METRONOME, DAZZLE_GLEAM, EXTRASENSORY, PSYCHIC_M, LIGHT_SCREEN, \
	     ICE_BEAM, REFLECT, THUNDERBOLT, CALM_MIND, SURF, \
	     FLASH
	; end
