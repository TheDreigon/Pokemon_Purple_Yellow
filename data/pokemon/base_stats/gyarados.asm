	...
	tmhm BIND, WATER_PULSE, RAGE, BODY_SLAM, IRON_TAIL, \
	     MIMIC, MIRROR_MOVE, SUBSTITUTE, METRONOME, AGILITY, \
	     IRON_HEAD, DRAGON_CLAW, INTIMIDATE, SCARY_FACE, TAKE_DOWN, \
	     ICE_BEAM, EARTHQUAKE, ROCK_SLIDE, DOUBLE_EDGE, THRASH, \
	     OUTRAGE, SURF, STRENGTH
	; end
