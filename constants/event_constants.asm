...
; Viridian City events
	...
	const EVENT_GOT_GIOVANNI_CANDY
...
; Cerulean City events
	...
	const EVENT_BEAT_CERULEAN_GYM_TRAINER_2 ; LILY, the third SENSATIONAL SISTER (2026-09-06)
	const_skip 1
	const EVENT_GOT_MISTY_TM
	const EVENT_BEAT_MISTY
	const EVENT_GOT_MISTY_CANDY
...
; Vermilion City events
	...
	const_skip
	const EVENT_GOT_SURGE_TM
	const EVENT_BEAT_LT_SURGE
	const EVENT_GOT_SURGE_CANDY
...
; Route 23 events
	...
	const EVENT_PASSED_GOLDBADGE_CHECK
...
; Route 24 events
	...
	const EVENT_DAMIAN_WANTED_IT_BACK ; v1.0 (2026-09-23): the Champion's CHARMELEON/CHARIZARD refused him
...
; v0.7 (2026-08-30, his design, v3): the two Oak's aides wait in the
; SAFFRON Pokecenter with the ITEMFINDER and EXP.SHARE. This latch marks
; "the entry cutscene already ran this visit"; the map's on-entry script
; CLEARS it again while a parcel is still owed, so the scene repeats once
