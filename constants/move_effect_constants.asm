...
; wStatModIndexOverride. Appended, never renumbered.
	...
	const DEFENSE_DOWN1_FLINCH_EFFECT ; $6F  target Defense-1 + ~30% flinch (Tickle; Forte 2026-09-08). Its own id because DEFENSE_DOWN1 is shared by seven other moves.
