...
.useRareCandy
	...
	add hl, bc ; hl now points to level
	push hl
; v0.7 (2026-09-01): the cap ladder lived INLINE here (a drifted copy of
; GetLevelCap's - the family hazard incarnate); deduped onto the one true
; ladder. b = the cap (MAX_LEVEL off hard / post-League, +1'd ace on hard).
