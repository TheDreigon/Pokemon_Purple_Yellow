...
CeladonMart5FClerk1Text::
	; Phase B.2: Celadon 5F (utility/setup). 11 TMs per spec.
	script_mart TM_DOUBLE_TEAM, TM_REFLECT, TM_LIGHT_SCREEN, TM_SWORDS_DANCE, TM_BULK_UP, TM_HONE_CLAWS, TM_CALM_MIND, TM_AGILITY, TM_INTIMIDATE, TM_FAKE_TEARS, TM_SCARY_FACE
