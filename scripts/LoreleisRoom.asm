...
LoreleisRoomTrainerHeader0:
	trainer EVENT_BEAT_LORELEIS_ROOM_TRAINER_0, TEXT_LORELEISROOM_LORELEI, LoreleisRoomLoreleiBeforeBattleText, LoreleisRoomLoreleiEndBattleText, LoreleisRoomLoreleiAfterBattleText
LoreleisRoomTrainerHeader1:
	trainer EVENT_BEAT_LORELEIS_ROOM_TRAINER_1, TEXT_LORELEISROOM_LORELEI_REMATCH, LoreleisRoomLoreleiRematchBeforeBattleText, LoreleisRoomLoreleiRematchEndBattleText, LoreleisRoomLoreleiRematchAfterBattleText
	db -1 ; end
