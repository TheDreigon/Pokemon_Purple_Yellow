...
PokemonMansion1F_TextPointers:
	...
	dw_const PickUpItemText,                TEXT_POKEMONMANSION1F_BURN_HEAL
	dw_const PickUpItemText,                TEXT_POKEMONMANSION1F_MAX_POTION
	dw_const PokemonMansion1FSwitchText,    TEXT_POKEMONMANSION1F_SWITCH

Mansion1TrainerHeaders:
	def_trainers
Mansion1TrainerHeader0:
	trainer EVENT_BEAT_MANSION_1_TRAINER_0, TEXT_POKEMONMANSION1F_SCIENTIST, PokemonMansion1FScientistBattleText, PokemonMansion1FScientistEndBattleText, PokemonMansion1FScientistAfterBattleText
	db -1 ; end
