...
.VitaminsList
	db 13, HP_UP, PROTEIN, IRON, CALCIUM, ZINC, CARBOS, RARE_CANDY, PP_UP, PP_MAX, ETHER, MAX_ETHER, ELIXIR, MAX_ELIXIR

.BattleList
	db 8, X_ATTACK, X_DEFEND, X_SPATK, X_SPDEF, X_SPEED, X_ACCURACY, DIRE_HIT, GUARD_SPEC
