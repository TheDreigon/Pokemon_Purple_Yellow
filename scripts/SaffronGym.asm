...
SaffronGymTrainerHeader0:
	trainer EVENT_BEAT_SAFFRON_GYM_TRAINER_0, TEXT_SAFFRONGYM_CHANNELER1, SaffronGymChanneler1BattleText, SaffronGymChanneler1EndBattleText, SaffronGymChanneler1AfterBattleText
SaffronGymTrainerHeader1:
	trainer EVENT_BEAT_SAFFRON_GYM_TRAINER_1, TEXT_SAFFRONGYM_PSYCHIC1, SaffronGymPsychic1BattleText, SaffronGymPsychic1EndBattleText, SaffronGymPsychic1AfterBattleText
SaffronGymTrainerHeader2:
	trainer EVENT_BEAT_SAFFRON_GYM_TRAINER_2, TEXT_SAFFRONGYM_CHANNELER2, SaffronGymChanneler2BattleText, SaffronGymChanneler2EndBattleText, SaffronGymChanneler2AfterBattleText
SaffronGymTrainerHeader3:
	trainer EVENT_BEAT_SAFFRON_GYM_TRAINER_3, TEXT_SAFFRONGYM_PSYCHIC2, SaffronGymPsychic2BattleText, SaffronGymPsychic2EndBattleText, SaffronGymPsychic2AfterBattleText
SaffronGymTrainerHeader4:
	trainer EVENT_BEAT_SAFFRON_GYM_TRAINER_4, TEXT_SAFFRONGYM_CHANNELER3, SaffronGymChanneler3BattleText, SaffronGymChanneler3EndBattleText, SaffronGymChanneler3AfterBattleText
SaffronGymTrainerHeader5:
	trainer EVENT_BEAT_SAFFRON_GYM_TRAINER_5, TEXT_SAFFRONGYM_PSYCHIC3, SaffronGymPsychic3BattleText, SaffronGymPsychic3EndBattleText, SaffronGymPsychic3AfterBattleText
SaffronGymTrainerHeader6:
	trainer EVENT_BEAT_SAFFRON_GYM_TRAINER_6, TEXT_SAFFRONGYM_PSYCHIC4, SaffronGymPsychic4BattleText, SaffronGymPsychic4EndBattleText, SaffronGymPsychic4AfterBattleText
	db -1 ; end
...
; v1.0 (the SPECIAL split, 2026-09-06): the GOLDBADGE lends SP.DEF now, so
; its speech gets the knob #17 twin - no boost claim on hard
	text_asm
	ld hl, .normal
	ld a, [wDifficulty]
	and a ; NORMAL_MODE?
...
.normal
	...
	text_end
.hard
	text_far _SaffronGymSabrinaGoldBadgeInfoHardText
	text_end
...
; not wait, so the receipt page is held back until the player presses.
	ld e, OPP_SABRINA ; v1.0: the HARD MODE badge match cap, announced (Pewter's note)
	ld d, 1
