...
IndigoPlateauLobbyClerkText::
	script_mart  ULTRA_BALL, HYPER_POTION, FULL_RESTORE, REVIVE, FULL_HEAL, MAX_REPEL, TM_FLAMETHROWER, TM_ICE_BEAM, TM_HYDRO_PUMP, TM_GIGA_DRAIN, TM_SOLARBEAM, TM_THUNDERBOLT, TM_CALM_MIND, TM_ROCK_SLIDE

IndigoPlateauLobbyPostGameClerkText::
	script_mart TM_SWORDS_DANCE, TM_TOXIC, TM_TAKE_DOWN, TM_BODY_SLAM, TM_DOUBLE_EDGE, TM_BLIZZARD, TM_THUNDER, TM_EARTHQUAKE, TM_THRASH, TM_PSYCHIC_M, TM_FIRE_BLAST, TM_HURRICANE, TM_DRAGON_RAGE, PP_UP
