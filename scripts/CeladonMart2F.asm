...
CeladonMart2FClerk2Text::
	; Phase B.2: Celadon 2F (early/mid damage). 11 TMs per spec.
	script_mart TM_SEISMIC_TOSS, TM_FAINT_ATTACK, TM_ROCK_THROW, TM_BIND, TM_QUICK_ATTACK, TM_KARATE_CHOP, TM_WATER_PULSE, TM_IRON_TAIL, TM_AERIAL_ACE, TM_BODY_SLAM, TM_DRAGON_CLAW
