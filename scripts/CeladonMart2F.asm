...
CeladonMart2FClerk2Text::
	...
	script_mart TM_FAINT_ATTACK, TM_DRAGON_CLAW, TM_QUICK_ATTACK, TM_BIND, TM_SEISMIC_TOSS, TM_AERIAL_ACE, TM_NIGHT_SHADE, TM_QUICK_ATTACK, TM_BODY_SLAM, TM_ROCK_THROW, TM_IRON_TAIL, TM_WATER_PULSE
