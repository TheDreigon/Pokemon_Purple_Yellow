...
CinnabarMartClerkText::
	script_mart ULTRA_BALL, HYPER_POTION, MAX_REPEL, ESCAPE_ROPE, FULL_HEAL, REVIVE, TM_WATER_PULSE, TM_BULLDOZE, TM_MIMIC, TM_METRONOME, TM_INTIMIDATE, TM_DRAGON_RAGE, TM_PSYCHIC_M, TM_THUNDER_WAVE