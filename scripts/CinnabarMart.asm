...
CinnabarMartClerkText::
	script_mart ULTRA_BALL, HYPER_POTION, MAX_REPEL, ESCAPE_ROPE, FULL_HEAL, REVIVE, TM_BUBBLEBEAM, TM_DIG, TM_MIMIC, TM_METRONOME, TM_DARK_PULSE, TM_HEAD_SMASH, TM_PSYWAVE, TM_TRI_ATTACK