...
Route11TrainerHeader0:
	trainer EVENT_BEAT_ROUTE_11_TRAINER_0, TEXT_ROUTE11_GAMBLER1, Route11Gambler1BattleText, Route11Gambler1EndBattleText, Route11Gambler1AfterBattleText
Route11TrainerHeader1:
	trainer EVENT_BEAT_ROUTE_11_TRAINER_1, TEXT_ROUTE11_GAMBLER2, Route11Gambler2BattleText, Route11Gambler2EndBattleText, Route11Gambler2AfterBattleText
Route11TrainerHeader2:
	trainer EVENT_BEAT_ROUTE_11_TRAINER_2, TEXT_ROUTE11_YOUNGSTER1, Route11Youngster1BattleText, Route11Youngster1EndBattleText, Route11Youngster1AfterBattleText
Route11TrainerHeader3:
	trainer EVENT_BEAT_ROUTE_11_TRAINER_3, TEXT_ROUTE11_SUPER_NERD1, Route11SuperNerd1BattleText, Route11SuperNerd1EndBattleText, Route11SuperNerd1AfterBattleText
Route11TrainerHeader4:
	trainer EVENT_BEAT_ROUTE_11_TRAINER_4, TEXT_ROUTE11_YOUNGSTER2, Route11Youngster2BattleText, Route11Youngster2EndBattleText, Route11Youngster2AfterBattleText
Route11TrainerHeader5:
	trainer EVENT_BEAT_ROUTE_11_TRAINER_5, TEXT_ROUTE11_GAMBLER3, Route11Gambler3BattleText, Route11Gambler3EndBattleText, Route11Gambler3AfterBattleText
Route11TrainerHeader6:
	trainer EVENT_BEAT_ROUTE_11_TRAINER_6, TEXT_ROUTE11_GAMBLER4, Route11Gambler4BattleText, Route11Gambler4EndBattleText, Route11Gambler4AfterBattleText
Route11TrainerHeader7:
	trainer EVENT_BEAT_ROUTE_11_TRAINER_7, TEXT_ROUTE11_YOUNGSTER3, Route11Youngster3BattleText, Route11Youngster3EndBattleText, Route11Youngster3AfterBattleText
Route11TrainerHeader8:
	trainer EVENT_BEAT_ROUTE_11_TRAINER_8, TEXT_ROUTE11_SUPER_NERD2, Route11SuperNerd2BattleText, Route11SuperNerd2EndBattleText, Route11SuperNerd2AfterBattleText
Route11TrainerHeader9:
	trainer EVENT_BEAT_ROUTE_11_TRAINER_9, TEXT_ROUTE11_YOUNGSTER4, Route11Youngster4BattleText, Route11Youngster4EndBattleText, Route11Youngster4AfterBattleText
	db -1 ; end
