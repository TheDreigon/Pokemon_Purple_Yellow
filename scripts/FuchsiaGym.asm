...
FuchsiaGymTrainerHeader2:
	trainer EVENT_BEAT_FUCHSIA_GYM_TRAINER_2, TEXT_FUCHSIAGYM_JANINE, FuchsiaGymJanineBattleText, FuchsiaGymJanineEndBattleText, FuchsiaGymJanineAfterBattleText
FuchsiaGymTrainerHeader3:
	trainer EVENT_BEAT_FUCHSIA_GYM_TRAINER_3, TEXT_FUCHSIAGYM_ROCKER4, FuchsiaGymRocker4BattleText, FuchsiaGymRocker4EndBattleText, FuchsiaGymRocker4AfterBattleText
FuchsiaGymTrainerHeader4:
	trainer EVENT_BEAT_FUCHSIA_GYM_TRAINER_4, TEXT_FUCHSIAGYM_ROCKER5, FuchsiaGymRocker5BattleText, FuchsiaGymRocker5EndBattleText, FuchsiaGymRocker5AfterBattleText
FuchsiaGymTrainerHeader5:
	trainer EVENT_BEAT_FUCHSIA_GYM_TRAINER_5, TEXT_FUCHSIAGYM_ROCKER6, FuchsiaGymRocker6BattleText, FuchsiaGymRocker6EndBattleText, FuchsiaGymRocker6AfterBattleText
	db -1 ; end
...
.normal
	...
	text_end
.hard
	text_far _FuchsiaGymKogaSoulBadgeInfoHardText
	text_end
...
; not wait, so the receipt page is held back until the player presses.
	ld e, OPP_KOGA ; v1.0: the HARD MODE badge match cap, announced (Pewter's note)
	ld d, 1
