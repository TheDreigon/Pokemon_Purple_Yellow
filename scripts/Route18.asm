...
Route18TrainerHeader0:
	trainer EVENT_BEAT_ROUTE_18_TRAINER_0, TEXT_ROUTE18_COOLTRAINER_M1, Route18CooltrainerM1BattleText, Route18CooltrainerM1EndBattleText, Route18CooltrainerM1AfterBattleText
Route18TrainerHeader1:
	trainer EVENT_BEAT_ROUTE_18_TRAINER_1, TEXT_ROUTE18_COOLTRAINER_M2, Route18CooltrainerM2BattleText, Route18CooltrainerM2EndBattleText, Route18CooltrainerM2AfterBattleText
Route18TrainerHeader2:
	trainer EVENT_BEAT_ROUTE_18_TRAINER_2, TEXT_ROUTE18_COOLTRAINER_M3, Route18CooltrainerM3BattleText, Route18CooltrainerM3EndBattleText, Route18CooltrainerM3AfterBattleText
	db -1 ; end
