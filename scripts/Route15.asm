...
Route15_TextPointers:
	...
	dw_const PickUpItemText,           TEXT_ROUTE15_TM_CHARM
	dw_const Route15SignText,          TEXT_ROUTE15_SIGN

Route15TrainerHeaders:
	def_trainers
Route15TrainerHeader0:
	trainer EVENT_BEAT_ROUTE_15_TRAINER_0, TEXT_ROUTE15_COOLTRAINER_F1, Route15CooltrainerF1BattleText, Route15CooltrainerF1EndBattleText, Route15CooltrainerF1AfterBattleText
Route15TrainerHeader1:
	trainer EVENT_BEAT_ROUTE_15_TRAINER_1, TEXT_ROUTE15_COOLTRAINER_F2, Route15CooltrainerF2BattleText, Route15CooltrainerF2EndBattleText, Route15CooltrainerF2AfterBattleText
Route15TrainerHeader2:
	trainer EVENT_BEAT_ROUTE_15_TRAINER_2, TEXT_ROUTE15_COOLTRAINER_M1, Route15CooltrainerM1BattleText, Route15CooltrainerM1EndBattleText, Route15CooltrainerM1AfterBattleText
Route15TrainerHeader3:
	trainer EVENT_BEAT_ROUTE_15_TRAINER_3, TEXT_ROUTE15_COOLTRAINER_M2, Route15CooltrainerM2BattleText, Route15CooltrainerM2EndBattleText, Route15CooltrainerM2AfterBattleText
Route15TrainerHeader4:
	trainer EVENT_BEAT_ROUTE_15_TRAINER_4, TEXT_ROUTE15_BEAUTY1, Route15Beauty1BattleText, Route15Beauty1EndBattleText, Route15Beauty1AfterBattleText
Route15TrainerHeader5:
	trainer EVENT_BEAT_ROUTE_15_TRAINER_5, TEXT_ROUTE15_BEAUTY2, Route15Beauty2BattleText, Route15Beauty2EndBattleText, Route15Beauty2AfterBattleText
Route15TrainerHeader6:
	trainer EVENT_BEAT_ROUTE_15_TRAINER_6, TEXT_ROUTE15_BIKER1, Route15Biker1BattleText, Route15Biker1EndBattleText, Route15Biker1AfterBattleText
Route15TrainerHeader7:
	trainer EVENT_BEAT_ROUTE_15_TRAINER_7, TEXT_ROUTE15_BIKER2, Route15Biker2BattleText, Route15Biker2EndBattleText, Route15Biker2AfterBattleText
Route15TrainerHeader8:
	trainer EVENT_BEAT_ROUTE_15_TRAINER_8, TEXT_ROUTE15_COOLTRAINER_F3, Route15CooltrainerF3BattleText, Route15CooltrainerF3EndBattleText, Route15CooltrainerF3AfterBattleText
Route15TrainerHeader9:
	trainer EVENT_BEAT_ROUTE_15_TRAINER_9, TEXT_ROUTE15_COOLTRAINER_F4, Route15CooltrainerF4BattleText, Route15CooltrainerF4EndBattleText, Route15CooltrainerF4AfterBattleText
	db -1 ; end
