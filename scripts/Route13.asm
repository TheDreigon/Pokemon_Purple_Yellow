...
Route13TrainerHeader0:
	trainer EVENT_BEAT_ROUTE_13_TRAINER_0, TEXT_ROUTE13_COOLTRAINER_M1, Route13CooltrainerM1BattleText, Route13CooltrainerM1EndBattleText, Route13CooltrainerM1AfterBattleText
Route13TrainerHeader1:
	trainer EVENT_BEAT_ROUTE_13_TRAINER_1, TEXT_ROUTE13_COOLTRAINER_F1, Route13CooltrainerF1BattleText, Route13CooltrainerF1EndBattleText, Route13CooltrainerF1AfterBattleText
Route13TrainerHeader2:
	trainer EVENT_BEAT_ROUTE_13_TRAINER_2, TEXT_ROUTE13_COOLTRAINER_F2, Route13CooltrainerF2BattleText, Route13CooltrainerF2EndBattleText, Route13CooltrainerF2AfterBattleText
Route13TrainerHeader3:
	trainer EVENT_BEAT_ROUTE_13_TRAINER_3, TEXT_ROUTE13_COOLTRAINER_F3, Route13CooltrainerF3BattleText, Route13CooltrainerF3EndBattleText, Route13CooltrainerF3AfterBattleText
Route13TrainerHeader4:
	trainer EVENT_BEAT_ROUTE_13_TRAINER_4, TEXT_ROUTE13_COOLTRAINER_F4, Route13CooltrainerF4BattleText, Route13CooltrainerF4EndBattleText, Route13CooltrainerF4AfterBattleText
Route13TrainerHeader5:
	trainer EVENT_BEAT_ROUTE_13_TRAINER_5, TEXT_ROUTE13_COOLTRAINER_M2, Route13CooltrainerM2BattleText, Route13CooltrainerM2EndBattleText, Route13CooltrainerM2AfterBattleText
Route13TrainerHeader6:
	trainer EVENT_BEAT_ROUTE_13_TRAINER_6, TEXT_ROUTE13_BEAUTY1, Route13Beauty1BattleText, Route13Beauty1EndBattleText, Route13Beauty1AfterBattleText
Route13TrainerHeader7:
	trainer EVENT_BEAT_ROUTE_13_TRAINER_7, TEXT_ROUTE13_BEAUTY2, Route13Beauty2BattleText, Route13Beauty2EndBattleText, Route13Beauty2AfterBattleText
Route13TrainerHeader8:
	trainer EVENT_BEAT_ROUTE_13_TRAINER_8, TEXT_ROUTE13_BIKER, Route13BikerBattleText, Route13BikerEndBattleText, Route13BikerAfterBattleText
Route13TrainerHeader9:
	trainer EVENT_BEAT_ROUTE_13_TRAINER_9, TEXT_ROUTE13_COOLTRAINER_M3, Route13CooltrainerM3BattleText, Route13CooltrainerM3EndBattleText, Route13CooltrainerM3AfterBattleText
	db -1 ; end
