...
PokemonMansion3F_TextPointers:
	...
	dw_const PickUpItemText,                TEXT_POKEMONMANSION3F_ZINC
	dw_const PickUpItemText,                TEXT_POKEMONMANSION3F_FULL_HEAL
...
Mansion3TrainerHeader0:
	trainer EVENT_BEAT_MANSION_3_TRAINER_0, TEXT_POKEMONMANSION3F_SUPER_NERD, PokemonMansion3FSuperNerdBattleText, PokemonMansion3FSuperNerdEndBattleText, PokemonMansion3FSuperNerdAfterBattleText
Mansion3TrainerHeader1:
	trainer EVENT_BEAT_MANSION_3_TRAINER_1, TEXT_POKEMONMANSION3F_SCIENTIST, PokemonMansion3FScientistBattleText, PokemonMansion3FScientistEndBattleText, PokemonMansion3FScientistAfterBattleText
	db -1 ; end
