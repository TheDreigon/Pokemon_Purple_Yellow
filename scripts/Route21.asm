...
Route21TrainerHeader0:
	trainer EVENT_BEAT_ROUTE_21_TRAINER_0, TEXT_ROUTE21_FISHER1, Route21Fisher1BattleText, Route21Fisher1EndBattleText, Route21Fisher1AfterBattleText
Route21TrainerHeader1:
	trainer EVENT_BEAT_ROUTE_21_TRAINER_1, TEXT_ROUTE21_FISHER2, Route21Fisher2BattleText, Route21Fisher2EndBattleText, Route21Fisher2AfterBattleText
Route21TrainerHeader2:
	trainer EVENT_BEAT_ROUTE_21_TRAINER_2, TEXT_ROUTE21_SWIMMER1, Route21Swimmer1BattleText, Route21Swimmer1EndBattleText, Route21Swimmer1AfterBattleText
Route21TrainerHeader3:
	trainer EVENT_BEAT_ROUTE_21_TRAINER_3, TEXT_ROUTE21_SWIMMER2, Route21Swimmer2BattleText, Route21Swimmer2EndBattleText, Route21Swimmer2AfterBattleText
Route21TrainerHeader4:
	trainer EVENT_BEAT_ROUTE_21_TRAINER_4, TEXT_ROUTE21_SWIMMER3, Route21Swimmer3BattleText, Route21Swimmer3EndBattleText, Route21Swimmer3AfterBattleText
Route21TrainerHeader5:
	trainer EVENT_BEAT_ROUTE_21_TRAINER_5, TEXT_ROUTE21_SWIMMER4, Route21Swimmer4BattleText, Route21Swimmer4EndBattleText, Route21Swimmer4AfterBattleText
Route21TrainerHeader6:
	trainer EVENT_BEAT_ROUTE_21_TRAINER_6, TEXT_ROUTE21_SWIMMER5, Route21Swimmer5BattleText, Route21Swimmer5EndBattleText, Route21Swimmer5AfterBattleText
Route21TrainerHeader7:
	trainer EVENT_BEAT_ROUTE_21_TRAINER_7, TEXT_ROUTE21_FISHER3, Route21Fisher3BattleText, Route21Fisher3EndBattleText, Route21Fisher3AfterBattleText
Route21TrainerHeader8:
	trainer EVENT_BEAT_ROUTE_21_TRAINER_8, TEXT_ROUTE21_FISHER4, Route21Fisher4BattleText, Route21Fisher4EndBattleText, Route21Fisher4AfterBattleText
	db -1 ; end
