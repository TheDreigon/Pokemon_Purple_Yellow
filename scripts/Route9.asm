...
Route9_TextPointers:
	...
	dw_const PickUpItemText,          TEXT_ROUTE9_TM_RAGE
	dw_const Route9SignText,          TEXT_ROUTE9_SIGN

Route9TrainerHeaders:
	def_trainers
Route9TrainerHeader0:
	trainer EVENT_BEAT_ROUTE_9_TRAINER_0, TEXT_ROUTE9_COOLTRAINER_F1, Route9CooltrainerF1BattleText, Route9CooltrainerF1EndBattleText, Route9CooltrainerF1AfterBattleText
Route9TrainerHeader1:
	trainer EVENT_BEAT_ROUTE_9_TRAINER_1, TEXT_ROUTE9_COOLTRAINER_M1, Route9AJBattleText, Route9AJEndBattleText, Route9AJAfterBattleText
Route9TrainerHeader2:
	trainer EVENT_BEAT_ROUTE_9_TRAINER_2, TEXT_ROUTE9_COOLTRAINER_M2, Route9CooltrainerM2BattleText, Route9CooltrainerM2EndBattleText, Route9CooltrainerM2AfterBattleText
Route9TrainerHeader3:
	trainer EVENT_BEAT_ROUTE_9_TRAINER_3, TEXT_ROUTE9_COOLTRAINER_F2, Route9CooltrainerF2BattleText, Route9CooltrainerF2EndBattleText, Route9CooltrainerF2AfterBattleText
Route9TrainerHeader4:
	trainer EVENT_BEAT_ROUTE_9_TRAINER_4, TEXT_ROUTE9_HIKER1, Route9Hiker1BattleText, Route9Hiker1EndBattleText, Route9Hiker1AfterBattleText
Route9TrainerHeader5:
	trainer EVENT_BEAT_ROUTE_9_TRAINER_5, TEXT_ROUTE9_HIKER2, Route9Hiker2BattleText, Route9Hiker2EndBattleText, Route9Hiker2AfterBattleText
Route9TrainerHeader6:
	trainer EVENT_BEAT_ROUTE_9_TRAINER_6, TEXT_ROUTE9_YOUNGSTER1, Route9Youngster1BattleText, Route9Youngster1EndBattleText, Route9Youngster1AfterBattleText
Route9TrainerHeader7:
	trainer EVENT_BEAT_ROUTE_9_TRAINER_7, TEXT_ROUTE9_HIKER3, Route9Hiker3BattleText, Route9Hiker3EndBattleText, Route9Hiker3AfterBattleText
Route9TrainerHeader8:
	trainer EVENT_BEAT_ROUTE_9_TRAINER_8, TEXT_ROUTE9_YOUNGSTER2, Route9Youngster2BattleText, Route9Youngster2EndBattleText, Route9Youngster2AfterBattleText
	db -1 ; end
