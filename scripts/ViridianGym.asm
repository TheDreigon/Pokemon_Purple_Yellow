...
ViridianGymTrainerHeader0:
	trainer EVENT_BEAT_VIRIDIAN_GYM_TRAINER_0, TEXT_VIRIDIANGYM_COOLTRAINER_M1, ViridianGymCooltrainerM1BattleText, ViridianGymCooltrainerM1EndBattleText, ViridianGymCooltrainerM1AfterBattleText
ViridianGymTrainerHeader1:
	trainer EVENT_BEAT_VIRIDIAN_GYM_TRAINER_1, TEXT_VIRIDIANGYM_HIKER1, ViridianGymHiker1BattleText, ViridianGymHiker1EndBattleText, ViridianGymHiker1AfterBattleText
ViridianGymTrainerHeader2:
	trainer EVENT_BEAT_VIRIDIAN_GYM_TRAINER_2, TEXT_VIRIDIANGYM_ROCKER1, ViridianGymRocker1BattleText, ViridianGymRocker1EndBattleText, ViridianGymRocker1AfterBattleText
ViridianGymTrainerHeader3:
	trainer EVENT_BEAT_VIRIDIAN_GYM_TRAINER_3, TEXT_VIRIDIANGYM_HIKER2, ViridianGymHiker2BattleText, ViridianGymHiker2EndBattleText, ViridianGymHiker2AfterBattleText
...
ViridianGymGymGuideText:
	text_asm
; v0.7 (2026-09-05): after the League the gym is KIYO's - the guide knows.
	ld a, [wGameStage]
	and a
	jr nz, .kiyoEra
	CheckEvent EVENT_BEAT_VIRIDIAN_GYM_GIOVANNI
...
; not wait, so the receipt page is held back until the player presses.
	...
	jr .done
.kiyoEra
	ld hl, ViridianGymGuideKiyoEraText
	call PrintText
	jr .done
.afterBeat
...
ViridianGymGuideKiyoEraText:
	text_far _ViridianGymGuideKiyoEraText
	text_end
